...
if (file_exists($file) && filesize($file) > 0) {
    ...
    foreach ($lignes as $ligne) {
        list($login, $mail, $mdp, $statut) = explode(";", $ligne);
        $utilisateurs[] = [
            'login' => $login,
            'mail' => $mail,
            'mdp' => $mdp,
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i])) {
                                echo "<td>" . $i+1 . "</td>";
                                echo "<td>" . $utilisateurs[$i]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+1])) {
                                echo "<td>" . $i+2 . "</td>";
                                echo "<td>" . $utilisateurs[$i+1]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+2])) {
                                echo "<td>" . $i+3 . "</td>";
                                echo "<td>" . $utilisateurs[$i+2]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+3])) {
                                echo "<td>" . $i+4 . "</td>";
                                echo "<td>" . $utilisateurs[$i+3]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+4])) {
                                echo "<td>" . $i+5 . "</td>";
                                echo "<td>" . $utilisateurs[$i+4]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+5])) {
                                echo "<td>" . $i+6 . "</td>";
                                echo "<td>" . $utilisateurs[$i+5]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+6])) {
                                echo "<td>" . $i+7 . "</td>";
                                echo "<td>" . $utilisateurs[$i+6]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+7])) {
                                echo "<td>" . $i+8 . "</td>";
                                echo "<td>" . $utilisateurs[$i+7]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+8])) {
                                echo "<td>" . $i+9 . "</td>";
                                echo "<td>" . $utilisateurs[$i+8]['login'] . "</td>";
                    ...
                    <tr>
                        <?php
                            if (isset($utilisateurs[$i+9])) {
                                echo "<td>" . $i+10 . "</td>";
                                echo "<td>" . $utilisateurs[$i+9]['login'] . "</td>";
