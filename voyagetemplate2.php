...
<div class="container">
    ...
    <div class="bloc_p_voyage">
        ...
        <div class="etape">
            ...
            <li><button onclick="envoyerFormulaire(this)">enregistrer le voyage</button></li>
            <li><button onclick="nextDiv(this)">confirmer</button></li>
            <li><button> <a href="derniervoy.php">accéder au récapitulatif</a></button></li>
        </div>
